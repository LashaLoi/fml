    ...
    <div className="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-gray-400 border-opacity-20">
      ...
      <div className="w-full sm:w-2/3 px-4">
        <div className="max-w-xl">
          ...
          >
            <div className="relative block px-3 w-full text-sm text-black placeholder-gray-500 font-medium  border-gray-400 hover:border-black focus-within:border-yellow-500 rounded-lg">
