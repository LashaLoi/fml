  ...
  return (
    <section
      className={`relative pt-24 pb-32 ${
        isSafari ? "" : "bg-fixed"
      } bg-center bg-cover bg-[url('/rod2.jpg')] overflow-hidden`}
    >
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 p-3">
            <div className="p-6 bg-white bg-opacity-80 border rounded-4xl">
              <p className="text-lg font-medium">
                Мне очень необходимо было это время. Я получила ответы на многие
                вопросы. Спасибо за этот проект!
              </p>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 p-3">
            <div className="p-6 bg-white bg-opacity-80 border rounded-4xl">
              <p className="text-lg font-medium">
                ...
                🔥🔥🔥 Бог говорил очень много вещей, и многое я смогу сказать,
                когда сделаю с Богом определённые шаги.
              </p>
            </div>
          </div>
          <div className="w-full md:w-1/2 lg:w-1/3 p-3">
            <div className="p-6 bg-white bg-opacity-80 border rounded-4xl">
              <p className="text-lg font-medium">
                Первый раз на ФМЛ. Спасибо за опыт, новые знакомства, за связи,
                которые будут служить взаимоскреплению.
              </p>
            </div>
          </div>
        </div>
